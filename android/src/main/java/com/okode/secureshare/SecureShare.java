...
public class SecureShare {
  ...
  private static final String PROVIDER_URI_SUFFIX = ".providers.secureshare/secureshare";
  private static final String PROTOCOL = "content://";
  private static final String FILENAME = "secshare";
  private static final String TAG = SecureShare.class.getSimpleName();
  private Context context;

  public SecureShare(Context context) {
